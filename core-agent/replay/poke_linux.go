...
// O_NOFOLLOW and AT_SYMLINK_NOFOLLOW below are load-bearing. With a daemon per
// account (ADR 0019) these paths are reached through /proc/<pid>/root of
// somebody else's container, so a symlink here was planted in a filesystem this
