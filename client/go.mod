// The client binary and everything only it uses.
//
// Its own module because it carries docker/cli and buildx -- 215 packages --
...
// provides -- so having both in the graph is an ambiguous import. Requiring
// the newer monolith is not enough, because `go mod tidy` drops a require
...
replace github.com/willscott/go-nfs => github.com/lhns/go-nfs v0.0.5-0.20260907110738-bced569c52ed
